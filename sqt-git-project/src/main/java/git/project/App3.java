...
public class App3 {
    ...
    public void testGetBooks() {
		...
		.body("[0].id", equalTo(2))
	    .body("[0].name", equalTo("The Life-Changing Magic of Tidying Up"))
	    .body("[0].author", equalTo("Marie Kondo"))
	    .body("[0].price", equalTo(9.69F))
		
		.body("[1].id", equalTo(3))
	    .body("[1].name", equalTo("Refactoring: Improving the Design of Existing Code"))
	    .body("[1].author", equalTo("Martin Fowler"))
	    .body("[1].price", equalTo(47.99F));
    }
